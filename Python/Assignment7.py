# -*- coding: utf-8 -*-
"""
Created on Fri Mar 13 00:33:34 2020
...
##Q9. Write a python program to replace all html tags by the space in the given
##string.
...
##Q10. . Write a python program to extract all the email addresses from the given
##string and print the output


import re
str1=input("Enter your email address: ")
regx="(([a-zA-Z0-9+._-]+)@([a-zA-Z0-9._-]+.[a-z]+))"
match=re.search(regx,str1)
if match!=None:
    print("Email address is:",match.group())
    print("mail:",match.group(2))
    print("Domain",match.group(3))
    
else:
    print("Don't have any email address")
