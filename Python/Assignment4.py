# -*- coding: utf-8 -*-
"""
Created on Mon Feb 24 23:46:06 2020
...
import functools
sum_odd=functools.reduce(lambda a,b:a+b,range(1,21,2))
...
import functools
sum_even=functools.reduce(lambda a,b:a+b,range(2,21,2))
...
import functools
even_square=[(x)**2 for x in range(2,21,2)]
...
large=functools.reduce(lambda x,y:x if x>y else y,[a,b,c])
